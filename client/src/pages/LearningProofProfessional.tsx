...
function LearningProofProfessionalContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Learning Proof - Professional Track</h1>
        <p className="text-muted-foreground mt-2">
          Document what you learned each week for your professional growth at Philip Morris (IQOS). These proofs become your evidence of upskilling and career advancement.
        </p>
      </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="text-xs text-muted-foreground bg-blue-50 p-3 rounded-lg border border-blue-200">
                        <p className="font-medium mb-1">💼 How Does This Apply to Your Professional Growth?</p>
                        <p>Optional: Add notes about how this applies to your IQOS work or career advancement at Philip Morris.</p>
                      </div>
                    </div>
                    <Button
...
export default function LearningProofProfessional() {
  return (
    <DashboardLayout>
      <LearningProofProfessionalContent />
    </DashboardLayout>
  );
}
