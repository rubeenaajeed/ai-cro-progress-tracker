...
export default function Roadmap() {
  ...
  const currentPhaseWeeks = currentPhase === "phase1" ? roadmapData.slice(0, 24) : roadmapData.slice(24);
  
  // Handle phase change
  const handlePhaseChange = (phase: "phase1" | "phase2") => {
    setCurrentPhase(phase);
    setCurrentWeekNumber(phase === "phase1" ? 1 : 25);
  };
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="sm"
              onClick={() => setCurrentWeekNumber(Math.max(currentPhase === "phase1" ? 1 : 25, currentWeekNumber - 1))}
              disabled={currentWeekNumber === (currentPhase === "phase1" ? 1 : 25)}
            >
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => setCurrentWeekNumber(Math.min(currentPhase === "phase1" ? 24 : 30, currentWeekNumber + 1))}
              disabled={currentWeekNumber === (currentPhase === "phase1" ? 24 : 30)}
            >
              Next
